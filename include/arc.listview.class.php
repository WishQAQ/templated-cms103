...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"up\" href='javascript:;'>上一页</a> <a class=\"cur\">".$this->TotalResult."</a> <a class=\"up\" href='javascript:;'>下一页</a>\r\n";
        }
        ...
        $purl = $this->GetCurUrl();
        $maininfo = "<a class=\"up\" href='javascript:;'>上一页</a> <a class=\"cur\">".$this->TotalResult."</a> <a class=\"up\" href='javascript:;'>下一页</a>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"up\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a>\r\n";
            $indexpage="<a class=\"up\" href='".str_replace("{page}",1,$tnamerule)."'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a>首页</a>\r\n";
        ...
        {
            $nextpage.="<a class=\"up\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>下一页</a>\r\n";
            $endpage="<a class=\"up\" href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"up\">末页</a>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class=\"up\" href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a>\r\n";
            }
        }
        $plist = '';
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        $maininfo = "<a class=\"up\" href='javascript:;'>上一页</a> <a class=\"cur\">".$this->TotalResult."</a> <a class=\"up\" href='javascript:;'>下一页</a></li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"up\" href='".$purl."PageNo=$prepagenum'>上一页</a>\r\n";
            $indexpage="<a class=\"up\" href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
            $indexpage="<a class=\"up\">首页</a>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"up\" href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
            $endpage="<a class=\"up\" href='".$purl."PageNo=$totalpage'>末页</a>\r\n";
        }
        else
        {
            $endpage="<a class=\"up\">末页</a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class=\"up\" href='".$purl."PageNo=$j'>".$j."</a>\r\n";
            }
        }
